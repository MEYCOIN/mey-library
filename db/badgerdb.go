/**
 *  @file
 *  @copyright defined in mey/LICENSE.txt
 */
...
import (
	...
	"github.com/meycoin/dbbadger"
	"github.com/meycoin/dbbadger/options"
	"github.com/meycoin/mey-library/log"
)
...
func newBadgerDB(dir string) (DB, error) {
	...
	// set mey-library logger instead of default badger stderr logger
	opts.Logger = logger
